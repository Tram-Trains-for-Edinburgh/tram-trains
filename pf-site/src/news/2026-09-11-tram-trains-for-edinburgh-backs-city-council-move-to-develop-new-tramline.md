---
title: Tram Trains for Edinburgh backs City Council move to develop new tramline
date: 2026-09-11T09:00:00.000+01:00
---
...
> "It's good to see the Council finally agreeing a clear policy on developing the North-South tram, which should connect with the South Sub at Cameron Toll to form a key transport hub. But by referring this to SEStransit, progress may be delayed, so the Council must push the regional transport body to include the N-S tram in its shortlist of preferred projects…. and very importantly, to move ahead quickly.
>
> TTfE will be doing the same to make sure reopening the South Sub is a priority scheme within SEStransit."

[Download the press release (PDF)](/assets/images/ttfe-press-release-11-09-26.pdf)
